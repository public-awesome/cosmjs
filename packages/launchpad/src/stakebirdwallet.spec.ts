...
import { StakebirdSigner } from "./stakebirdwallet";

describe("StakebirdSigner", () => {
  const defaultPrivkey = fromHex("b8c462d2bb0c1a92edf44f735021f16c270f28ee2c3d1cb49943a5e70a3c763e")
  const defaultAddress = "stb1kxt5x5q2l57ma2d434pqpafxdm0mgeg96vptum";
  const defaultPubkey = fromHex("03f146c27639179e5b67b8646108f48e1a78b146c74939e34afaa5414ad5c93f8a");

  describe("fromPrivateKey", () => {
    it("works", async () => {
      const signer = await StakebirdSigner.fromPrivateKey(defaultPrivkey)
